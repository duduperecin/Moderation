...
bot.on("ready", () => {
    ...
    bot.user.setActivity(`Eu estou em ${bot.guilds.size} servidores`);
    bot.user.setPresence({ game: { name: 'Use "h!ajuda" 💻.', type: 1, url: 'https://www.twitch.tv/frachzin_'} });
  // caso queira o bot trasmitindo use:
  /*
     bot.user.setPresence({ game: { name: 'comando', type: 1, url: 'https://www.twitch.tv/ladonegro'} });
      //0 = Jogando
      //  1 = Transmitindo
      //  2 = Ouvindo
      //  3 = Assistindo
